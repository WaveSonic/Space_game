...
def table_record():
    ...
    text_1 = font.render(f"{data['1']['name']}: {data['1']['score']}", True, (255, 0, 0))
    ...
    text_2 = font.render(f"{data['2']['name']}: {data['2']['score']}", True, (255, 0, 0))
    ...
    text_3 = font.render(f"{data['3']['name']}: {data['3']['score']}", True, (255, 0, 0))
    ...
    text_4 = font.render(f"{data['4']['name']}: {data['4']['score']}", True, (255, 0, 0))
    ...
    text_5 = font.render(f"{data['5']['name']}: {data['5']['score']}", True, (255, 0, 0))
